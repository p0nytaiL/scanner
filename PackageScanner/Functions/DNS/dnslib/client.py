...
from PackageScanner.Functions.DNS.dnslib.dns import DNSRecord,DNSHeader,DNSQuestion,QTYPE
from PackageScanner.Functions.DNS.dnslib.digparser import DigParser
