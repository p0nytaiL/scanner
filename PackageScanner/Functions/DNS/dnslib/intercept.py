...
from PackageScanner.Functions.DNS.dnslib import DNSRecord,RR,QTYPE,RCODE,parse_time
from PackageScanner.Functions.DNS.dnslib.server import DNSServer,DNSHandler,BaseResolver,DNSLogger
from PackageScanner.Functions.DNS.dnslib.label import DNSLabel
